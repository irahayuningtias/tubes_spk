					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="adminkit-dev/static/pages-profile.html"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
					...
					<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Sistem Pendukung Keputusan</h5>
								</div>
								<div class="card-body">
									<p>Aplikasi website ini merupakan website untuk mencari keputusan terbaik
										dari berbagai alternatif pilihan dengan menggunakan kombinasi metode 
										SMART-TOPSIS
								</div>
							</div>
						</div>
